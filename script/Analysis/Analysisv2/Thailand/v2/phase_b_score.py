#!/usr/bin/env python3
"""
phase_b_score.py  --  Phase B: Preliminary Scoring  --  Thailand  --  v2
=========================================================================
...
------------------------------------------------------
  sections_scored_thailand.gpkg    Sections with all score columns
  sections_scored_thailand.parquet Same with geometry
...
parquet_in = os.path.join(RESULTS_DIR, "sections_thailand.parquet")
...
gpkg_out    = os.path.join(RESULTS_DIR, "sections_scored_thailand.gpkg")
parquet_out = os.path.join(RESULTS_DIR, "sections_scored_thailand.parquet")

sections.to_file(gpkg_out, driver="GPKG", layer="sections_scored")
print(f"  [Saved] sections_scored_thailand.gpkg  ({len(sections):,} sections)")

sections.to_parquet(parquet_out, index=False)
print(f"  [Saved] sections_scored_thailand.parquet")
